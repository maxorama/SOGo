Vagrant.configure("2") do |config|
  ...
  config.vm.network :private_network,
    ...
    :ovirt__ip => '192.168.10.30', :ovirt__network_name => 'ovirtmgmt', :ovirt__gateway => '192.168.10.254', :ovirt__netmask => '255.255.255.0', :ovirt__dns_servers => '192.168.10.1', :ovirt__dns_search => '<<domain>>'
  ...
  config.vm.provider :ovirt4 do |ovirt|
    ...
    ovirt.template = 'CentOS_7.4_Tmpl'
    ovirt.console = 'vnc'
